...
export class SnrComputer {
   ...
   */
  request(label, audioBuffer, sampleRate) {
  ...
  _compute(label, audioBuffer, sampleRate) {
    ...
    const toIdx = (t) => Math.round(t * sampleRate);
