...
function parseBooleanFlag(value: any) {
...
export function saveAnalysisBackendConfig({ mode, endpoint }: any) {
  try {
...
export function normalizeAnalysisBackendConfig({ mode, endpoint }: any) {
  const platformLocal = loadPlatformLocalFlag();
