...
export function createPlayerHTML(opts = {}) {
    ...
    const hide = (flag: unknown) => flag ? '' : ' style="display:none"';
    ...
    <div class="toolbar" data-aw="toolbarRoot">
      ...
      <div class="toolbar-secondary" data-aw="toolbarSecondary">
        ...
        <!-- Toggle tools -->
        <span class="toolbar-group"${hide(o.showViewToggles)}>
        ...
        <button class="toolbar-btn settings-toggle-btn" data-aw="settingsToggleBtn" title="Open settings panel"${hide(o.showFFTControls)}>Settings</button>
      </div>
    </div>
