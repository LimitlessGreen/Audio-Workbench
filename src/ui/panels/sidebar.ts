...
export class Sidebar {
   ...
   */
  addPanel(id: any, { icon, label, element, onActivate, onDeactivate }: any) {
  ...
  _initResize() {
    ...
    this._handle.addEventListener('pointerdown', (e: any) => {
      e.preventDefault();
      dragging = true;
      startX = e.clientX;
