// ═══════════════════════════════════════════════════════════════════════
// SpectrogramController.js — spectrogram data, pipeline, and rendering
//
...
export class SpectrogramController extends EventTarget {
     ...
     */
    setExternalImage(image, options = {}) {
     ...
     * @param {import('./coordinateSystem.js').CoordinateSystem} p.coords
